const links = [["News", "/news"], ["Games", "/games"], ["Calendar", "/calendar"], ["Compare", "/compare"], ["Find My MMO", "/find-my-mmo"], ["Writers", "/writers"], ["Editorial Standards", "/editorial-standards"], ["AI Transparency", "/ai-transparency"], ["Advertising Disclosure", "/advertising-disclosure"], ["Privacy", "/privacy"]] as const;
...
export function PublicFooter() {
  return <footer className="public-footer"><div className="public-footer-inner"><p>MyRPG.IO is MMO intelligence with human accountability. Editorial content is source-linked and human-reviewed.</p><nav aria-label="Site information">{[["Writers", "/writers"], ["Editorial Standards", "/editorial-standards"], ["AI Transparency", "/ai-transparency"], ["Advertising Disclosure", "/advertising-disclosure"], ["Privacy", "/privacy"]].map(([label, href]) => <a key={href} href={href}>{label}</a>)}</nav></div></footer>;
}
