...
export const EDITORIAL_GRAPHICS = {
  ...
  "science-transit": { label: "Science-fiction transit intelligence", src: "/editorial/science-transit-intelligence.png", alt: "Original MyRPG deep-space transit lattice with abstract jump rings and energy routes", width: 1672, height: 941 },
  "science-campaign": { label: "Science-fiction campaign intelligence", src: "/editorial/science-campaign-intelligence.png", alt: "Original MyRPG interstellar campaign map with a luminous nebula and abstract strategic routes", width: 1672, height: 941 },
