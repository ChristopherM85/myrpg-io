...
type GameSubmission = { id: string; gameName: string; studioName?: string | null; officialUrl: string; sourceUrl?: string | null; description: string; coverageLane: string; lifecycleStatus?: string | null; platforms?: string | null; submitterNote?: string | null; imageR2Key?: string | null; imageContentType?: string | null; imageWidth?: number | null; imageHeight?: number | null; imageAltText?: string | null; rightsConfirmed: boolean; promotionalAssetPermission: boolean; status: string; createdAt: string };
