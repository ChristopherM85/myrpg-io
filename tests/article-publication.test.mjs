...
test("article publication requires an explicit owner decision and verified intake", async () => {
  ...
  for (const rule of ["Only the Owner can publish.", "Only the Owner can approve article publication readiness.", "ownerApproved", "sourceCache", "120–180-word draft"]) assert.ok(source.includes(rule));
});
